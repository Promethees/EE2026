...
#set_property PACKAGE_PIN P3 [get_ports {check_ptr_0}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {check_ptr_0}]
#set_property PACKAGE_PIN N3 [get_ports {check_ptr_1}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {check_ptr_1}]
#set_property PACKAGE_PIN P1 [get_ports {check_ptr_2}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {check_ptr_2}]
#set_property PACKAGE_PIN L1 [get_ports {check_ptr_3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {check_ptr_3}]
